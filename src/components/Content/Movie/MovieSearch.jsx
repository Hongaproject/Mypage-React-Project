          ...
          : (<form onSubmit={this.handleSubmit}>
            <div>
              ...
              <div className="movies">
                {movies.map(movie => (
                	<MovieSearch key={movie.link} id={movie.link} year={movie.pubDate} title={movie.title} poster={movie.image} rating={movie.userRating} director={movie.director} actor={movie.actor}
					/>))
                 }
              </div>
            </div>
